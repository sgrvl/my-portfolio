...
`;
const Github = ({ link, width = '24', height = '24', strokeW = '2' }) => (
	<a href={link} target='_blank' rel='noreferrer'>
		<Button>
			<StyledSvg width={width} height={height} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
				<g clipPath='url(#clip0_206_308)'>
					<path
